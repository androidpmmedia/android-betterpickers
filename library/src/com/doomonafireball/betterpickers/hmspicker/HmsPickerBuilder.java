...
public class HmsPickerBuilder {
  ...
  private Vector<HmsPickerDialogHandler> mHmsPickerDialogHandlers =
      new Vector<HmsPickerDialogHandler>();
  ...
  /**
   * Attach a reference to this Picker instance. This is used to track multiple pickers, if the user
   * wishes.
   *
  ...
  public void show() {
    ...
    final HmsPickerDialogFragment fragment =
        HmsPickerDialogFragment.newInstance(mReference, styleResId);
