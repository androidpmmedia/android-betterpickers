...
public class DatePickerBuilder {
  ...
  private Vector<DatePickerDialogHandler> mDatePickerDialogHandlers =
      new Vector<DatePickerDialogHandler>();
  ...
  /**
   * Pre-set a zero-indexed month of year. This is highly frowned upon as it contributes to user
   * confusion.  The
   * Pickers do a great job of making input quick and easy, and thus it is preferred to always
   * start
   * with a blank
   * slate.
   *
  ...
  /**
   * Pre-set a day of month. This is highly frowned upon as it contributes to user confusion.  The
   * Pickers do a great
   * job of making input quick and easy, and thus it is preferred to always start with a blank
   * slate.
   *
  ...
  /**
   * Pre-set a year. This is highly frowned upon as it contributes to user confusion.  The Pickers
   * do a great job of
   ...
   * most use cases, this
   * method is not necessary as attachment to an Activity or Fragment is done automatically.  If,
   * however, you would
  ...
  public void show() {
    ...
    final DatePickerDialogFragment fragment =
        DatePickerDialogFragment.newInstance(mReference, styleResId, monthOfYear, dayOfMonth, year);
