...
public class RadialTimePickerDialog extends DialogFragment implements OnValueSelectedListener {
  ...
  /**
   * The callback interface used to indicate the user is done filling in the time (they clicked on
   * the 'Set' button).
   */
  ...
  public static RadialTimePickerDialog newInstance(OnTimeSetListener callback, int hourOfDay,
   ...
   *
   * @param enteredZeros A size-2 boolean array, which the caller should initialize, and which may
   * then be used for
   * the caller to know whether zeros had been explicitly entered as either hours of minutes. This
   * is helpful for
  ...
  /**
   * Simple node class to be used for traversal to check for legal times. mLegalKeys represents the
   * keys that can be
