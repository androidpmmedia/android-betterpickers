...
public class ZeroTopPaddingTextView extends TextView {
  ...
  public void updatePadding() {
    ...
    if (getPaint().getTypeface() != null && getPaint().getTypeface()
        .equals(Typeface.DEFAULT_BOLD)) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH &&
        getText() != null &&
        (getText().toString().equals(decimalSeperator) || getText().toString()
            .equals(timeSeperator))) {
