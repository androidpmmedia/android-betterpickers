...
public class UnderlinePageIndicatorPicker extends View implements PageIndicator {
  ...
  public UnderlinePageIndicatorPicker(Context context, AttributeSet attrs, int defStyle) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.BetterPickersDialogFragment, defStyle, 0);
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (mTitleView != null) {
      ...
      canvas.drawRect(lineLeft, getPaddingBottom(), lineRight, getHeight() - getPaddingBottom(),
          mPaint);
    }
  }
