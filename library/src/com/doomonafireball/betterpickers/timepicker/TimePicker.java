...
public class TimePicker extends LinearLayout
  ...
  protected void updateTime() {
    ...
    if (mInputPointer > -1) {
      ...
      if (mInputPointer >= 0) {
        ...
        if ((mIs24HoursMode && digit >= 3 && digit <= 9) || (!mIs24HoursMode
            && digit >= 2
            && digit <= 9)) {
          hours1 = -2;
        }
      ...
      if (mInputPointer > 0 && mInputPointer < 3 && hours1 != -2) {
        ...
        if ((mIs24HoursMode && digits >= 24 && digits <= 25) || (!mIs24HoursMode
            && digits >= 13
            && digits <= 15)) {
          hours1 = -2;
        }
  ...
  /**
   * Clicking on the bottom right button will add "00" to the time in AM/PM mode and "30" is 24
   * hours mode.
   *
  ...
  /**
   * Returns the time already entered in decimal representation. if time is H1 H2 : M1 M2 the value
   * retured is
