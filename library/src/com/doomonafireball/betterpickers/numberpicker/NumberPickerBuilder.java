...
public class NumberPickerBuilder {
   ...
   * or View.GONE.  When using View.INVISIBLE, the +/- button will still be present in the layout
   * but be
   * non-clickable. When set to View.GONE, the +/- button will disappear entirely, and the "0"
   * button will occupy its
   * space.
   *
   ...
   * View.VISIBLE,
   * View.INVISIBLE, or View.GONE.  When using View.INVISIBLE, the decimal button will still be
   * present in the layout
   * but be non-clickable. When set to View.GONE, the decimal button will disappear entirely, and
   * the "0" button will
   * occupy its space.
   *
  ...
  public void show() {
    ...
    final NumberPickerDialogFragment fragment =
        NumberPickerDialogFragment.newInstance(mReference, styleResId, minNumber, maxNumber,
