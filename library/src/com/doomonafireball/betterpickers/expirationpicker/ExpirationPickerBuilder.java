...
public class ExpirationPickerBuilder {
  ...
  private Vector<ExpirationPickerDialogHandler> mExpirationPickerDialogHandlers =
      new Vector<ExpirationPickerDialogHandler>();
   ...
   * @return the current Builder object
   */
  public ExpirationPickerBuilder addExpirationPickerDialogHandler(
      ExpirationPickerDialogHandler handler) {
   ...
   * @return the current Builder object
   */
  public ExpirationPickerBuilder removeExpirationPickerDialogHandler(
      ExpirationPickerDialogHandler handler) {
  ...
  public void show() {
    ...
    final ExpirationPickerDialogFragment fragment =
        ExpirationPickerDialogFragment.newInstance(mReference, styleResId, monthOfYear, year);
