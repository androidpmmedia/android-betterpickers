...
public class ExpirationPickerDialogFragment extends DialogFragment {
   ...
   * @return a Picker!
   */
  public static ExpirationPickerDialogFragment newInstance(int reference, int themeResId,
      Integer monthOfYear, Integer year) {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    if (mMonthOfYear != -1 || mYear != 0) mPicker.setExpiration(mYear, mMonthOfYear);
