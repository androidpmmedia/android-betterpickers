...
public abstract class TouchExplorationHelper<T> extends AccessibilityNodeProviderCompat
  ...
  /**
   * Invalidates cached information about the parent view. <p> You <b>must</b> call this method
   * after adding or
  ...
  /**
   * Invalidates cached information for a particular item. <p> You <b>must</b> call this method when
   * any of the
   * properties set in {@link #populateNodeForItem(Object, AccessibilityNodeInfoCompat)} have
   * changed. </p>
   */
   ...
   * android.os.Bundle)}. <p> The helper class automatically handles focus management resulting from
   * {@link
   * AccessibilityNodeInfoCompat#ACTION_ACCESSIBILITY_FOCUS} and {@link
   * AccessibilityNodeInfoCompat#ACTION_CLEAR_ACCESSIBILITY_FOCUS},
   * so typically a developer only needs to handle actions added manually in the {{@link
   * #populateNodeForItem(Object,
  ...
  /**
   * Populates an event with information about the specified item. <p> At a minimum, a developer
   * must populate the
   * event text by doing one of the following: <ul> <li>appending text to {@link
   * android.view.accessibility.AccessibilityEvent#getText()}</li>
  ...
  /**
   * Populates a node with information about the specified item. <p> At a minimum, a developer must:
   * <ul> <li>populate
   * the event text using {@link AccessibilityNodeInfoCompat#setText(CharSequence)} or {@link
   * AccessibilityNodeInfoCompat#setContentDescription(CharSequence)} </li> <li>set the item's
  ...
  /**
   * Populates a list with the parent view's visible items. <p> The result of this method is cached
   * until the
  ...
  /**
   * Returns the item for a unique identifier. If the specified item does not exist, returns {@code
   * null}.
   *
